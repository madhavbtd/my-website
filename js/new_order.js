# Cleaned and corrected new_order.js content

clean_corrected_new_order_js = """
...
async function handleFormSubmit(event) {
    ...
    try{
        ...
        // Create customerDetails object (optional)
        ...
        payload.customerId = cId; // ADDED THIS LINE
...
# Create the corrected, clean file
with open("new_order_clean_corrected.js", "w", encoding="utf-8") as f:
    f.write(clean_corrected_new_order_js)

print("Cleaned and corrected file 'new_order_clean_corrected.js' has been created.")